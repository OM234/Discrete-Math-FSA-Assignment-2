...
def makeDFA():
    ...
    DFATransitionTable = DFATransitionCompletion(DFATransitionTable, DFAStates, alphabet)
    ...
    for state in DFAStates:
        for symbol in alphabet:
            ...
            if not alreadyComplete:
                completeTransitionTable.append((state, symbol, "TRP"))
                hasTrap = True

    if hasTrap:
        for symbol in alphabet:
            completeTransitionTable.append(("TRP", symbol, "TRP"))
